...
<form method="POST" action="{{ route('admin.product-details.store') }}">
    @csrf

    <div class="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">

        <div class="border-b border-slate-200 px-6 py-4">
            <h2 class="text-base font-semibold text-slate-800">Branch Catalog Entry</h2>
            <p class="mt-0.5 text-sm text-slate-500">Configure pricing, stock, and availability for a specific product at a specific branch.</p>
        </div>
            ...
            <div class="sm:col-span-2">
                <label class="flex cursor-pointer items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500">Uncheck to hide this product from customers at this branch without removing the entry.</p>
                    </div>
                </label>
            </div>
