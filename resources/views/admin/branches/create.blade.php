    ...
    <div class="space-y-5">
        ...
        <div class="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
            ...
            <div class="grid grid-cols-1 gap-6 p-6 sm:grid-cols-2">
                ...
                <div>
                    <label for="label" class="{{ $label }}">Branch Label <span class="text-slate-400 font-normal">(optional)</span></label>
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-slate-400">2-letter ISO country code.</p>
            ...
            <div class="grid grid-cols-1 gap-6 p-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <input id="lat" name="lat" type="number" step="any"
                           value="{{ old('lat') }}"
                           class="{{ $input }}" placeholder="40.71280">
                ...
                <div>
                    ...
                    <input id="lng" name="lng" type="number" step="any"
                           value="{{ old('lng') }}"
                           class="{{ $input }}" placeholder="-74.00600">
                ...
                <div class="sm:col-span-2 space-y-4">
                    <label class="flex cursor-pointer items-start gap-3">
                        ...
                        <input type="checkbox" name="is_active" value="1"
                               class="mt-0.5 h-4 w-4 rounded border-slate-300 text-orange-500 accent-orange-500"
                    ...
                    <label class="flex cursor-pointer items-start gap-3">
                        ...
                        <input type="checkbox" name="accept_orders" value="1"
                               class="mt-0.5 h-4 w-4 rounded border-slate-300 text-orange-500 accent-orange-500"
                               {{ old('accept_orders', true) ? 'checked' : '' }}>
                        <div>
